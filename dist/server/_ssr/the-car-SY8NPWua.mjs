...
import { N as Nav, P as PageHero, S as SectionLabel, a as PillLink, C as CrossLink, F as Footer } from "./Primitives-BUEavZDk.mjs";
import "./index.mjs";
...
import "node:https";
import "node:http2";
const workshop = "/assets/vision_R500%20_goodwood_landscape_2-CDfa323G.png";
const engine = "/assets/ENGINE-BDR4qXPc.png";
const theCar = "/assets/goodwood_landscape-ZdZmTO5n.png";
const design = "/assets/vision_R500_goodwood_landscape-DCix3yC6.png";
...
function TheCarPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "bg-background text-foreground min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHero, { eyebrow: "01 / The Car", title: "Car №148.", italic: "Reborn.", intro: "Acquired in 2024 after fifteen years in storage. Dismantled with archaeological care, scanned, catalogued and reborn through additive manufacture, classic coachbuilding and motorsport-grade engineering.", img: heroImg }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 md:py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1500px] mx-auto px-6 md:px-10 grid md:grid-cols-12 gap-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-7 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: theCar, alt: "Silver Ford Sierra RS500", className: "w-full " }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 md:py-32 border-t border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1500px] mx-auto px-6 md:px-10 grid md:grid-cols-12 gap-12 items-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-7 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: engine, alt: "Engine", className: "w-full  aspect-[4/3] object-cover" }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 md:py-32 border-t border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1500px] mx-auto px-6 md:px-10 grid md:grid-cols-12 gap-12 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-7 overflow-hidden order-2 md:order-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: workshop, alt: "Workshop", className: "w-full  aspect-[4/3] object-cover" }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "h-[45vh] md:h-[65vh] relative overflow-hidden border-t border-b border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-fixed bg-cover bg-center  opacity-60 parallax-bg", style: {
