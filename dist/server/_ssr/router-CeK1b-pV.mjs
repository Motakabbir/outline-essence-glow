...
import "node:https";
import "node:http2";
const appCss = "/assets/styles-DnS4dBdY.css";
...
const partners = [{
  ...
  name: "AL YASID DESIGN ",
  role: "AUTOMOTIVE VISUALISOR",
  body: "Creative Automotive visualisation and AI specialist "
}];
...
const groups = [{
  ...
  title: "The Car",
  items: [["Is the donor shell genuine?", "Yes. A matching-numbers RS500 shell, fully documented, acquired in 2023. This is number 148 of 500. Provenance is published to custodians."], ["What is being changed?", "The body will be coach built aluminium with modern underpinnings, so yes much will be changed."], ["Will it be road-legal?", "The completed car will be road legal and used by the Members."]]
}, {
  title: "Custodianship",
  items: [["What do custodians actually get?", "Founder Members will have access to the car for 16 days per year for three years, Associate Members will be invited to two experience track days per year. "], ["Can I drive the car?", "Yes , if you are a Founder Member"], ["What happens after three years?", "The Rs500 will be prepared to be sold."]]
}, {
  title: "Application",
  items: [["How do I apply?", "Apply via www.syndicatedrestomod.com "], ["Is there a selection process?", "First come first served limited to 10 Founder and 20 Associate Members."], ["What are the costs?", "Founder Members one off fee of £25,000 for Associate Members £5000 one off fee."]]
}];
