...
import { N as Nav, C as CrossLink, F as Footer, a as PillLink, S as SectionLabel } from "./Primitives-BUEavZDk.mjs";
import { b as blueprint } from "./blueprint_vRS500_ 001-BI1XW04k.mjs";
...
function Hero() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "top", className: "relative min-h-screen flex items-end overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("video", { src: heroVideo, autoPlay: true, muted: true, loop: true, playsInline: true, className: "absolute inset-0 w-full h-full object-cover opacity-70  scale-[1.04]" }),
...
function Manifesto() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-32 md:py-48 border-t border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1500px] mx-auto px-6 md:px-10 grid md:grid-cols-12 gap-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 overflow-hidden border border-white/10 bg-white/[0.02]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: blueprint, alt: "vRS500 Blueprint", className: "w-full h-auto object-cover  opacity-55 transition-all duration-700 ease-out hover:scale-105 hover:opacity-100" }) })
    ] }),
...
function HighlightCar() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-28 md:py-40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1500px] mx-auto px-6 md:px-10 grid md:grid-cols-12 gap-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-7 overflow-hidden reveal aspect-[4/3] bg-white/5 relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: theCarImage, alt: "The Car", className: "w-full h-full object-cover  zoom-hover" }) }),
...
function HighlightProcess() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-28 md:py-40 border-t border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1500px] mx-auto px-6 md:px-10 grid md:grid-cols-12 gap-12 items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-8 text-white/70 leading-relaxed max-w-xl", children: "Fully documented from the forensic dismantle through to the first turn of the key." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-7 overflow-hidden reveal aspect-[4/3] bg-white/5 relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: processImage, alt: "Process", className: "w-full h-full object-cover  zoom-hover" }) })
  ] }) });
}
function HighlightExperience() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "paper", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1500px] mx-auto px-6 md:px-10 py-28 md:py-40 grid md:grid-cols-12 gap-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-7 overflow-hidden reveal aspect-[4/3] bg-white/5 relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx("video", { src: partnerVideo, autoPlay: true, muted: true, loop: true, playsInline: true, className: "w-full h-full object-cover  zoom-hover" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-5 md:pt-6", children: [
