...
import { b as Route$3 } from "./router-F7gP3RwE.mjs";
import "./index.mjs";
...
function AboutPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "bg-background text-foreground min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHero, { eyebrow: "05 / About", title: "An Agile Studio", italic: "with one obsession.", intro: "Vision148 was founded to build a single car — a definitive Ford Sierra RS500 Cosworth — and to share its making with a small number of custodians who care as deeply as we do.", video: videoBg }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 md:py-32 paper", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1500px] mx-auto px-6 md:px-10 grid md:grid-cols-12 gap-12 items-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-7 h-[300px] md:h-[450px] overflow-hidden relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-fixed bg-cover bg-center  opacity-80 parallax-bg", style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 md:py-32 border-t border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1500px] mx-auto px-6 md:px-10 grid md:grid-cols-12 gap-12 items-start", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-7 border-t border-white/10 mt-12 md:mt-0", children: teamMembers.map(({
        position,
        name,
        image
        ...
        image && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-start md:justify-end md:w-1/3 w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: image, alt: name, className: "w-20 h-20 md:w-28 md:h-28 shrink-0 object-cover rounded-full  group-hover:-0 transition-all duration-500 group-hover:scale-105 border border-white/10" }) })
      ] }, name)) })
    ] }) }),
