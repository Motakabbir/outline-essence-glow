...
const design = "/assets/witness_the_build-CU3Gmirn.jpg";
...
function ExperiencePage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "bg-background text-foreground min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHero, { eyebrow: "04 / The Experience", title: "Ownership,", italic: "reimagined.", intro: "Ten custodians. One car. A year-round programme of access, hospitality and shared craftsmanship — engineered with the same care as the build itself.", video: partnerVideo }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "paper", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1500px] mx-auto px-6 md:px-10 py-24 md:py-32 grid md:grid-cols-12 gap-12 items-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-7 overflow-hidden reveal aspect-[4/3] relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: experience, alt: "Hospitality", className: "w-full h-full  object-cover zoom-hover" }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 md:py-32 border-t border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1500px] mx-auto px-6 md:px-10 grid md:grid-cols-12 gap-12 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-7 overflow-hidden reveal aspect-[4/3] relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: design, alt: "Digital twin", className: "w-full h-full  object-cover zoom-hover" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-8 text-white/70 leading-relaxed max-w-xl", children: "The Vision148 RS500 will not be built in a silo. We intend to showcase the very best in artisan and bleeding edge technology throughout this build, coach building and additive manufacturing will feature prominently as well as the talented people involved with the project who lead the way in specialist car builds. Every new component, every decision, every piece of provenance attached to its place on the car will be documented and accessible." })
      ] })
    ] }) }),
