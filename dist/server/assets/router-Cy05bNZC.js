...
import { m as mapSeoToMeta, b as fetchSeoMetadata, a as fetchPartners, f as fetchFaqs, c as fetchTeamMembers } from "./api-Drrs5acz.js";
import { T as TSS_SERVER_FUNCTION, g as getServerFnById, a as createServerFn } from "./server-Ci16uXs1.js";
import { z } from "zod";
...
const $$splitComponentImporter$b = () => import("./the-car-DBAYQS5I.js");
...
const $$splitComponentImporter$a = () => import("./process-Mj6P3vuj.js");
...
const $$splitComponentImporter$9 = () => import("./partners-B0ajlsEJ.js");
const partners = [{
  name: "DMC",
...
const $$splitComponentImporter$8 = () => import("./journal-hdlc17Rz.js");
...
const $$splitComponentImporter$7 = () => import("./faq-DC4esEt-.js");
const groups = [{
  title: "The Programme",
...
const $$splitComponentImporter$6 = () => import("./experience-CwOT9J8S.js");
...
const $$splitComponentImporter$5 = () => import("./contact-Br2qK5Yx.js");
...
const $$splitComponentImporter$4 = () => import("./apply-D0T8WL6V.js");
...
const $$splitComponentImporter$3 = () => import("./about-CkjjXVAM.js");
const team = [{
...
const $$splitComponentImporter$2 = () => import("./index-Ca0FSef_.js");
...
const $$splitComponentImporter$1 = () => import("./journal.index-s-WowO4w.js");
...
const posts = [
  {
    ...
    content: /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx("p", { children: "In the painstaking process of reviving #148, the initial dismantling phase proved crucial. Working alongside our dedicated partners at ASM, we meticulously stripped the vehicle down to its barest essentials. Every component, no matter how minute, was carefully cataloged and preserved for the ensuing steps." }),
      /* @__PURE__ */ jsx("p", { children: "The journey from a complete car to a bare metal chassis is not merely about taking things apart—it is about establishing a flawless foundation. Once stripped, the shell was prepared for an intensive ICE blasting process. This state-of-the-art cleaning technique ensures that decades of road wear, old paint, and accumulated debris are removed without compromising the integrity of the underlying steel." }),
      /* @__PURE__ */ jsx("h3", { children: "Digital Precision Meets Analog Craft" }),
      /* @__PURE__ */ jsx("p", { children: "Perhaps the most vital step in this phase was the comprehensive 3D scanning of the bare shell. This scan provides us with an absolute, uncompromising digital datum—a perfect blueprint against which every subsequent repair, alignment, and modification will be measured. It bridges the gap between historical coachbuilding techniques and cutting-edge additive manufacturing, ensuring that when #148 returns to the road, it does so with a precision that was unimaginable in 1987." })
    ] })
  },
  {
    ...
    img: engine,
    content: /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx("p", { children: "Detailed build notes regarding the Mahle Powertrain process will go here. A deep dive into the engineering required to rebirth the iconic YBD block." }) })
  },
  {
    slug: "digital-twin",
    date: "Mar 2026",
    ...
    img: design,
    content: /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx("p", { children: "Detailed notes regarding the digital twin modelling process will go here. Every single component is meticulously rendered before physical work begins." }) })
  },
  {
    slug: "first-dinner",
    date: "Feb 2026",
    ...
    img: experience,
    content: /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx("p", { children: "Detailed notes regarding the first syndicate dinner will go here, highlighting the community aspect of the Vision148 project." }) })
  },
  {
    slug: "provenance",
    date: "apr 2026",
    ...
    img: theCar,
    content: /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx("p", { children: "Detailed notes regarding the extraordinary chain of custody for the donor car will go here, tracing its history back to 1987." }) })
  }
];
const $$splitComponentImporter = () => import("./journal._slug-BfddZ0I5.js");
