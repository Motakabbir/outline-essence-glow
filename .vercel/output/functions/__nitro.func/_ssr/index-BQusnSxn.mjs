...
const url = "/__l5e/assets-v1/2ae9fea4-7eaa-4850-a087-25f790a667d4/hero-video.mp4";
const heroVideo = {
  url
};
...
function Hero() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "top", className: "relative min-h-screen flex items-end overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("video", { src: heroVideo.url, poster: heroCar, autoPlay: true, muted: true, loop: true, playsInline: true, className: "absolute inset-0 w-full h-full object-cover opacity-70 grayscale" }),
