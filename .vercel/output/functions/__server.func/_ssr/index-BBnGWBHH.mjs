...
import { N as Nav, C as CrossLink, F as Footer, a as PillLink, S as SectionLabel } from "./Primitives-C10q8h9m.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "top", className: "relative min-h-screen flex items-end overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-[1500px] mx-auto px-6 md:px-10 pb-20 md:pb-28 w-full reveal", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12 grid md:grid-cols-12 gap-8 items-end", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "md:col-span-7 text-base md:text-lg text-white/70 max-w-2xl leading-relaxed", children: "The restoration and re-engineering of car #148 of the original 500 Ford Sierra RS500 Cosworths — reimagined through digital manufacturing, artisan coachbuilding, and a private syndicate of twenty-five." }),
