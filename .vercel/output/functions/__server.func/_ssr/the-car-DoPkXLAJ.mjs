...
import { N as Nav, P as PageHero, S as SectionLabel, a as PillLink, C as CrossLink, F as Footer } from "./Primitives-C10q8h9m.mjs";
...
function TheCarPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "bg-background text-foreground min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHero, { eyebrow: "01 / The Car", title: "Car №148.", italic: "Reborn.", intro: "Acquired in 2024 after fifteen years in storage. Dismantled with archaeological care, scanned, catalogued and reborn through additive manufacture, classic coachbuilding and motorsport-grade engineering." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 md:py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1500px] mx-auto px-6 md:px-10 grid md:grid-cols-12 gap-12", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-5 md:pt-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel, { n: "02", title: "Provenance" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-8 text-white/70 leading-relaxed", children: "Sourced through specialist channels. Provenance verified. Every original component catalogued. Every replacement traced to a named manufacturer." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-white/55 text-sm leading-relaxed", children: "The full archive is shared quarterly with syndicate members, alongside build photography, CAD updates and the live digital twin." })
      ] })
    ] }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 md:py-32 border-t border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1500px] mx-auto px-6 md:px-10 grid md:grid-cols-12 gap-12 items-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-5 order-1 md:order-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-4xl md:text-5xl uppercase leading-[0.95] mt-8", children: [
          "Steel, aluminium,",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif-italic normal-case opacity-70", children: "printed polymer." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-8 text-white/70 leading-relaxed", children: "Original panels restored by hand at Coventry Metalcraft. New components — including the dashboard — additively manufactured at the DMC, Silverstone." }),
