...
const partners = [{
  ...
  body: "Classic RS specialists. Donor dismantle, archival photography, parts conservation."
}, {
  name: "BAMD",
  role: "Additive Manufacture",
  body: "Polymer and metal additive components — including the printed dashboard architecture."
}, {
  name: "Cornerstone",
  role: "Composite Tooling",
  body: "Composite tooling, jigs and fixtures supporting the assembly programme."
}, {
  name: "HGL",
  role: "Logistics & Storage",
  body: "Climate-controlled storage, transport, and the chain-of-custody for every component."
}];
function PartnersPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "bg-background text-foreground min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Nav, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHero, { eyebrow: "03 / Partners", title: "A curated", italic: "consortium.", intro: "Each partner is best-in-class — additive manufacturing, coachbuilding, composites, engine engineering. Selected to elevate the technical and commercial credibility of a one-of-one, investment-grade build." }),
