...
function ContactPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "bg-background text-foreground min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHero, { eyebrow: "06 / Contact", title: "Get in", italic: "touch.", intro: "The studio answers personally. Most messages receive a reply within two working days." }),
