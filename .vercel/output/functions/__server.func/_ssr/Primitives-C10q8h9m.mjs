...
function PageHero({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "pt-40 md:pt-52 pb-20 md:pb-28 border-b border-white/10 relative grain", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1500px] mx-auto px-6 md:px-10 reveal", children: [
